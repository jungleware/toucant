...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xffffb878),
      onPrimaryFixedVariant: Color(0xff6b3b04),
      ...
      tertiaryFixed: Color(0xffdfe8b2),
      onTertiaryFixed: Color(0xff181e00),
      tertiaryFixedDim: Color(0xffc3cb98),
      onTertiaryFixedVariant: Color(0xff434a22),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff87521b),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffa1672f),
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff71794c),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff3d2816),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xffffb878),
      onPrimary: Color(0xff4c2700),
      primaryContainer: Color(0xff6b3b04),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xff131800),
      tertiaryContainer: Color(0xff8d9566),
      ...
      scrim: Color(0xff000000),
      inverseSurface: Color(0xffefe0d5),
      inversePrimary: Color(0xff6c3c05),
      primaryFixed: Color(0xffffdcc1),
      ...
      tertiaryFixedDim: Color(0xffc3cb98),
      onTertiaryFixedVariant: Color(0xff323913),
      surfaceDim: Color(0xff19120c),
      surfaceBright: Color(0xff413730),
      surfaceContainerLowest: Color(0xff130d07),
      surfaceContainerLow: Color(0xff221a14),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffffbd84),
      onPrimaryContainer: Color(0xff000000),
      ...
      primaryFixedDim: Color(0xffffbd84),
      ...
      onTertiaryFixedVariant: Color(0xff131800),
      surfaceDim: Color(0xff19120c),
      surfaceBright: Color(0xff413730),
      surfaceContainerLowest: Color(0xff130d07),
      surfaceContainerLow: Color(0xff221a14),
